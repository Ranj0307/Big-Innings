    ...
    if analysis_type == 'Network Analysis':
        ...
        if 'selected_players' not in st.session_state:
            ...
            if filtered_data.shape[0] != 0:
                ...
                total_times_dismissed = grouped_data['times_dismissed'].sum()
                ...
                top_dismissed_count = grouped_data.sort_values(by='times_dismissed', ascending=False).iloc[-1]['times_dismissed']
                chosen_batsman_data = grouped_data[grouped_data['batsman'] == top_dismissed_batsman]
                chosen_batsman_dismissed_count = chosen_batsman_data['times_dismissed'].sum()
                ...
                - The batsman he dismissed the most is {top_dismissed_batsman}."""
